...
public class ProActivity extends AppCompatActivity {
    Button Addmoney,Withdrawlmoney,gamecolor,timer,contact,alphabet,newapp;
    TextView balance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      databaseReference.addValueEventListener(new ValueEventListener() {
        ...
        newapp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t=new Intent(ProActivity.this,newapp.class);
                startActivity(t);
            }
        });
        ...
        alphabet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t=new Intent(ProActivity.this,AdminActivity.class);
                startActivity(t);
            }
        });
        contact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t=new Intent(ProActivity.this,ContactActivity.class);
                startActivity(t);
            }
        });
